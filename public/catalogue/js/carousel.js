...
$(".tf-sw-collection").each(function (index, element) {
  var $this = $(this);
  ...
  new Swiper(this, {
    ...
    speed: 1000,
    pagination: {
      el: $this.find(".sw-pagination-collection")[0],
      clickable: true,
    },
    slidesPerGroup: 1,
    navigation: {
      clickable: true,
      nextEl: $this.closest(".flat-categorie").find(".nav-next-collection")[0],
      prevEl: $this.closest(".flat-categorie").find(".nav-prev-collection")[0],
      nextEl: $this.closest(".flat-categorie").find(".nav-next-collection")[0],
